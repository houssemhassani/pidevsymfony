        ...
        foreach ($context['_seq'] as $context["_key"] => $context["employee"]) {
            ...
            echo "</td>
                                        <td>
                                            <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_gestio_citoyen_show", ["id" => twig_get_attribute($this->env, $this->source, $context["employee"], "id", [], "any", false, false, false, 35)]), "html", null, true);
            echo "\">Détail</a>
                                            <a href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_gestion_citoyen_refuser", ["id" => twig_get_attribute($this->env, $this->source, $context["employee"], "id", [], "any", false, false, false, 36)]), "html", null, true);
            echo "\">Refuser</a>
                                            <a href=\"";
            // line 37
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_gestion_citoyen_accepter", ["id" => twig_get_attribute($this->env, $this->source, $context["employee"], "id", [], "any", false, false, false, 37)]), "html", null, true);
            echo "\">Accepter</a>
                                        </td>
                                    </tr>
                                ";
...
";
    ...
    {
        return array (  162 => 44,  157 => 41,  147 => 37,  143 => 36,  139 => 35,  134 => 33,  130 => 32,  126 => 31,  122 => 30,  119 => 29,  115 => 28,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Gestion Citoyen{% endblock %}
                ...
                <div class=\"col-lg-12\">
                    ...
                    <div class=\"card\">
                        <div class=\"card-body\">
                            ...
                            <table class=\"table datatable\">
                                ...
                                {% for employee in citoyens %}
                                    <tr>
                                        ...
                                        <td>{{ employee.cin }}</td>
                                        <td>
                                            <a href=\"{{ path('app_gestio_citoyen_show', {'id': employee.id}) }}\">Détail</a>
                                            <a href=\"{{ path('app_gestion_citoyen_refuser', {'id': employee.id}) }}\">Refuser</a>
                                            <a href=\"{{ path('app_gestion_citoyen_accepter',{'id':employee.id}) }}\">Accepter</a>
                                        </td>
                                    </tr>
                                {% endfor %}
                                </tbody>
                            ...
                            <br/>
                            <a href=\"{{ path('app_gestio_citoyen_new') }}\">Ajouter nouveau</a>
                            <!-- End Table with stripped rows -->
