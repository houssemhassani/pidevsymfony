...
class __TwigTemplate_891113f8e0ba52b2c12da16b140611c5caaf31157115ba007d0d5d0d29a712c2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "\">back to list</a>
                        ...
                        <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employee_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["employee"]) || array_key_exists("employee", $context) ? $context["employee"] : (function () { throw new RuntimeError('Variable "employee" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
        echo "\">edit</a>
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Cin</th>
                <td>{{ employee.cin }}</td>
                <td> <a href=\"{{ path('app_employee_index') }}\">back to list</a>
...
{% endblock %}
", "employee/show.html.twig", "C:\\xampp\\htdocs\\PidevSymfony\\templates\\employee\\show.html.twig");
    }
}
