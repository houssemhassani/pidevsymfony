...
class __TwigTemplate_2db8ceee8b79a03ce662a397fb15d7d094c48ae976736d835883dc8ed7d8b446 extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["employee"]) {
            ...
            echo "</td>
                    ...
                    <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employee_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["employee"], "id", [], "any", false, false, false, 35)]), "html", null, true);
            echo "\">Supprimer</a>
                    <a href=\"";
            // line 36
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_employee_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["employee"], "id", [], "any", false, false, false, 36)]), "html", null, true);
            echo "\">Modifier</a>
                    </td>
                 </tr>
                 ";
    ...
    <section class=\"section\">
      <div class=\"row\">
        <div class=\"col-lg-12\">
          ...
          <div class=\"card\">
            <div class=\"card-body\">
            <a href=\"{{ path('app_employee_new') }}\"><i class=\"ri-arrow-left-circle-fill\" style=\"font-size: 50px;\"></i></a>
              <h5 class=\"card-title\">Liste des Employées</h5>
              <!-- Table with stripped rows -->
              <table class=\"table datatable\">
                <thead>
                ...
                {% for employee in employees %}
                  <tr>
                    ...
                    <td>{{ employee.cin }}</td>
                    <td>
                    <a href=\"{{ path('app_employee_delete', {'id': employee.id}) }}\">Supprimer</a>
               ...
               <br/>
                <a href=\"{{ path('app_employee_new') }}\">Ajouter nouveau</a>
              <!-- End Table with stripped rows -->
